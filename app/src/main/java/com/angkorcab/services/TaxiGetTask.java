 ...
 */
public class TaxiGetTask extends AsyncTask<String,String,String> {


    protected Context context;
    private ProgressDialog dialog;
    private String TAG = TaxiGetTask.class.getSimpleName();
    private String response;
    private UserData userData;
    private TaskCallback taskCallback;


    public TaxiGetTask(TaskCallback taskCallback, Context context){
    ...
    protected String doInBackground(String... params) {
        String url = ServiceUrl.TAXI_GET;
    ...
    Handler myHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    Log.i(TAG,"logger");
                    taskCallback.done(TaskCallback.Action.GET_TAXI);
