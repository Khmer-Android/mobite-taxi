...
public interface IWebConstant {
    ...
    String SERVER_KEY_FORGCM = "AIzaSyCiac3IcSQMc5Uex0FdTgcr9L4nGLGf-dk";
    /**
     * GCM PROJECT ID used fro notifications ]myan cab
     * /https://console.firebase.google.com/project/angkorcab-8b444/settings/cloudmessaging
    public static final String SENDER_ID = "130904704766";
    /**
     * SPLASH TIME OUTing and emulator runs in fast virt mode.
     console on port 5554, ADB on port 5555

     */
    public static final String SENDER_ID = "639037316367";
