...
public class ProjectURls {
 ...
 public static String BASE_URL = "http://app.angkorcab.com/ws/user_profile.php";
 ...
 public static String RIDES_Driver_URL = BASE_URL + "driver_rides.php?email=";
 public static String RIDES_Passenger_URL = BASE_URL + "passenger_rides.php?email=";
 // Gcm Registration URL
 public static final String SERVER_URL = BASE_URL + "gcm_register.php";
 // update driver
 public static final String GET_DRIVER_CURRENT_LOCATION = BASE_URL + "track_driver.php";
 // DriverStatus Urls
 public static String GET_DRIVER_STATUS_URL = BASE_URL + "get_driver_status.php";
 public static String DRIVER_STATUS_CHANGE_URL = BASE_URL + "update_driver_status.php";
 public static String DRIVER_UPDATE_LOC_URL = BASE_URL + "update_driver_lat&long.php";
 // Current RIDE Booking URLShd
 ...
 public static String UPDATE_USER_LOCATION_URL = BASE_URL + "cal_distance.php";
 ...
 public static String CONFIRM_REJECT_URL = BASE_URL + "ride_later_confirm.php";

 // not yet using...
 public static String RIDE_REJECT = BASE_URL + "ride_reject.php";

 public static String CONFIRM_REJECT_Now_URL = BASE_URL + "ride_now_confirm.php";
 public static String Update_Payment_Details_URL = BASE_URL + "payment_response.php";
 ...
 * */
 public static String getProfileUrl(String username, String user_type) {
  return PROFILE_ACTIVITY_URL + "?email=" + username + "&user_type=" + user_type.toLowerCase();
 }

 public static String TRACK_DRIVER_URL = BASE_URL + "user_track_driver.php?driver_id=";
